...
The first four components are being developed in May 2026 ahead of the [UNICEF Climate & Health 2026](https://www.unicef.org/innovation/call-for-application-climate-and-health-2026) application. A fifth component (`imci-rules`) is fully specified and ships after the grant decision.
...
| `triage-ranges` | Pediatric vital sign reference ranges by age band | In development | Working state by 2026-05-15 |
