...
2. **Curvas de crecimiento OMS.** Peso, talla, IMC y percentiles calculados localmente desde una tabla LMS OMS empaquetada. El alpha usa tablas compactas offline con interpolación. Alimenta vigilancia de estado de crecimiento y nutrición; la evaluación formal de desnutrición aguda requiere peso-para-talla/longitud o MUAC y no se afirma en este alpha.
